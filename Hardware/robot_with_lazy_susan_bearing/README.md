...
Additionally, a printable step-by-step lego/ikea-styled tutorial is available as an alternative. [Assembly Manual](InstructionManual.pdf). All associated CAD files and schematics are in the [Documentation](Documentation) directory.
